        ...
        <div className="flex items-center gap-3">
          ...
          {activeTab === 'details' && isApproved && (
            <button
              ...
              disabled={updating}
              className={`flex items-center gap-2 border font-semibold px-4 py-2 rounded-lg transition-colors text-sm disabled:opacity-50 ${isActive
          ...
          <div className={`max-w-[1120px] mx-auto px-6 lg:px-10 ${isRejected ? 'pt-6' : 'pt-6'}`}>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex items-center gap-3 text-xs font-bold uppercase tracking-wider">
                  <span className={`px-3 py-1.5 rounded-lg border ${venue.approval?.status === 'approved' ? 'bg-green-50 text-green-700 border-green-200' :
                  ...
                  <span className={`px-3 py-1.5 rounded-lg border ${venue.venueStatus === 'active' ? 'bg-green-50 text-green-700 border-green-200' : 'bg-gray-50 text-gray-700 border-gray-200'
                    }`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-12">
              {images.map((img, idx) => (
                <div
                  key={idx}
                  className={`h-[300px] md:h-[400px] rounded-2xl overflow-hidden bg-gray-100 ${idx === 0 && images.length >= 3 ? 'md:col-span-2' : ''
                    }`}
                >
                  <img
                    src={img}

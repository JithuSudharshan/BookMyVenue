    ...
    <footer className="bg-white pt-16 pb-8 border-t border-border">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Column 1 */}
          <div>
            <h3 className="text-primary font-bold text-xl mb-2">BookMyVenue</h3>
            <p className="text-secondary text-sm mb-1 font-medium">Kerala's trusted venue booking platform</p>
            <p className="text-secondary text-sm leading-relaxed">
              The premium destination for finding and booking exceptional spaces for your next big event in Kerala.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-3 mt-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-gray-100 hover:bg-primary hover:text-white text-gray-600 flex items-center justify-center transition-colors"
